/*  
 *  ---  3G_22 - Uploading files to a FTPS server from 3G module's SD   --- 
 *  
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        { 
            ...
            {     
                ...
                // 6. uploads file from 3G module (D:/Picture directory) to the FTPS server:
                answer = _3G.uploadFileSecure(4, "File_name");
                if (answer == 1)
                {
