...
void loop()
{
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        { 
            ...
            answer = _3G.configureFTP("ftp_server", "ftp_port", "user_name", "password", 1, "I");
            if (answer == 1)
            {     
                USB.println(F("Uploading the file 1..."));

                // 6a. uploads file from SD card to the FTP server
                answer = _3G.uploadData("/SD_path/filename", "/ftp_path/ftp_filename");
                ...
                answer = _3G.uploadData("/filename", "/ftp_filename");
