/*  
 *  ----  3G_20 - Downloading files to 3G module from a FTP server   ------ 
 *  
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        { 
            ...
            {     
                ...
                // 6. downloads file to 3G module (current directory) from the FTP server:
                answer = _3G. downloadFile("/FTP_path/FTP_file_name", 0, 180 );
                if (answer == 1)
                {
