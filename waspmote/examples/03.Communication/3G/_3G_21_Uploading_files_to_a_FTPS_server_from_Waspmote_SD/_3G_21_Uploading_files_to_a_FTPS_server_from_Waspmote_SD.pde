/*  
 *  ---  3G_21 - Uploading files to a FTPS server from Waspmote's SD   --- 
 *  
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        {     
            ...
            {     
                ...
                // 6a. uploads file from SD card to the FTPS server:
                answer = _3G.uploadDataSecure("/SD_path/filename", "/ftp_path/ftp_filename");
                if (answer == 1)
                {
                ...
                // 6b. uploads file from SD card to the FTPS server:
                answer = _3G.uploadDataSecure("/filename", "/ftp_filename");
                if (answer == 1)
                {
                    USB.println(F("Upload done"));
                }
