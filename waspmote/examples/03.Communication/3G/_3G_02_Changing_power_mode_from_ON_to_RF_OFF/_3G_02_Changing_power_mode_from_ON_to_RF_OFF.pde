/*  
 *  ------  3G_02 - Changing power mode from ON to RF_OFF  -------- 
 *  
...
void setup()
{
    ...
    {        
        ...
        USB.println(F("Power off the RF circuits of 3G module")); 
        USB.println(F("SIM card and functionalities without RF still active"));

        if (_3G.setMode(_3G_RF_OFF) == 1)
        {
