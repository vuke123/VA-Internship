/*  
 *  ----  3G_24 - Downloading files to 3G module from a FTPS server   ------ 
 *  
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        { 
            ...
            {     
                ...
                // 6. downloads file to 3G module (current directory) from the FTPS server:
                answer = _3G. downloadFile("/FTPS_path/FTPS_file_name", 0, 180 );
                if (answer == 1)
                {
