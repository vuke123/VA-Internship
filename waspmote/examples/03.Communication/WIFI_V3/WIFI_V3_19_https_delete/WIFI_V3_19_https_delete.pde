/*
    ...
    Explanation: This example shows how to perform HTTPS DELETE requests
...
void loop()
{
  ...
  {
    //////////////////////////////////////////////////
    // 1. Perform the HTTPS DELETE
    //////////////////////////////////////////////////
    error = WIFI_PRO_V3.httpsDelete(HTTP_PATH);

    // check response
    if (error == 0)
    {
      USB.print(F("HTTPS DELETE done!\r\nStatus: "));
      USB.println(WIFI_PRO_V3._httpResponseStatus,DEC);
    }
    else
    {
      USB.println(F("Error in HTTPS DELETE!"));  
    }
  }
  else
  {
  ...
  USB.println(F("1. WiFi switched OFF"));
delay(10000);
}
