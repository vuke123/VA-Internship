/*
    ...
    Explanation: This example shows how to perform HTTPS PUT requests
...
error = WIFI_PRO_V3.ON(socket);
  ...
  {
    //////////////////////////////////////////////////
    // 1. Perform the HTTPS POST
    //////////////////////////////////////////////////
    error = WIFI_PRO_V3.httpsPut(HTTP_PATH,DATA);

    // check response
    if (error == 0)
    {
      USB.print(F("HTTPS PUT done!\r\nStatus: "));
      USB.println(WIFI_PRO_V3._httpResponseStatus,DEC);
    }
    else
    {
      USB.println(F("Error in HTTPS PUT!"));  
    }
  }
  else
  {
