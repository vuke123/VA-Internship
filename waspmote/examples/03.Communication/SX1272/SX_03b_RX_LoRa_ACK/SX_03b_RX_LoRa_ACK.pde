 ...
 *  sending an acknowledgement (ACK) to the sender.
 *
...
void setup() 
{
  // Init USB port
  USB.ON();
  USB.println(F("SX_03b example"));
  USB.println(F("Semtech SX1272 module RX in LoRa with ACKs"));
