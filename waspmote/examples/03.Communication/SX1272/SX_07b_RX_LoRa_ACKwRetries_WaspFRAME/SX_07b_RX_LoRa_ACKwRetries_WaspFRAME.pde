/*  
 *  ------ [SX_07b] - RX LoRa with ACKs and Retries -------- 
 *  
 *  Explanation: This example shows how to receive a Waspmote Frame
 *  via SX1272 module. Steps performed:
 *    - Configurate the LoRa mode
 *    - Receive a packet sending an ACK in that case
 *  
...
void setup() 
{
  // Init USB port
  USB.ON();
  USB.println(F("SX_07b example"));
  USB.println(F("Semtech SX1272 module. RX LoRa with Waspmote Frame, ACKs and Retries"));
