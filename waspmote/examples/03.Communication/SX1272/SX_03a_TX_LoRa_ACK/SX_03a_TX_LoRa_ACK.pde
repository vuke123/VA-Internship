 ...
 *  waiting for the acknowledgement (ACK) from the receiver
 *
...
void setup()
{
  // Init USB port
  USB.ON();
  USB.println(F("SX_03a example"));
  USB.println(F("Semtech SX1272 module TX in LoRa with ACKs"));
...
void loop()
{
  ...
  e = sx1272.sendPacketTimeoutACK(rx_address, "this_is_the_data_message");
