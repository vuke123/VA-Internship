...
void loop()
{
  ...
  error = xbee900.receivePacketTimeout( 20000 );
  ...
  {    
    ...
    destination[0] = xbee900._srcMAC[0]; 
    destination[1] = xbee900._srcMAC[1]; 
    destination[2] = xbee900._srcMAC[2]; 
    destination[3] = xbee900._srcMAC[3]; 
    destination[4] = xbee900._srcMAC[4]; 
    destination[5] = xbee900._srcMAC[5]; 
    destination[6] = xbee900._srcMAC[6]; 
    destination[7] = xbee900._srcMAC[7]; 
    ...
    // send XBee packet
    error = xbee900.send( destination, "Message_from_RX_node" );       
