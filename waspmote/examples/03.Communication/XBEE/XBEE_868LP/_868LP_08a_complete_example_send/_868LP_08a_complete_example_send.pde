/*  
 *  ------ [868LP_08a] - complete example send  ------
 *  
 *  Explanation: This is a complete example for XBee-868LPMhz.
...
//////////////////////////////////////////
char RX_ADDRESS[] = "0013A20040B75660";
//////////////////////////////////////////
...
{ 
  ...
  if( error == 0 ) 
  {
    ...
    USB.printHex( xbee868LP._srcMAC[0] );    
    USB.printHex( xbee868LP._srcMAC[1] );    
    USB.printHex( xbee868LP._srcMAC[2] );    
    USB.printHex( xbee868LP._srcMAC[3] );    
    USB.printHex( xbee868LP._srcMAC[4] );    
    USB.printHex( xbee868LP._srcMAC[5] );    
    USB.printHex( xbee868LP._srcMAC[6] );    
    USB.printHex( xbee868LP._srcMAC[7] );    
    USB.println();
  }
  else
  {
