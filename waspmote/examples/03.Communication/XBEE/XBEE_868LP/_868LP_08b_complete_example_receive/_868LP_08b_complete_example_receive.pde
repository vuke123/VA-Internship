/*  
 *  ------ [868LP_08b] - complete example receive  ------
 *  
 *  Explanation: This is a complete example for XBee-868LP
...
void loop()
{
  ...
  error = xbee868LP.receivePacketTimeout( 20000 );
  ...
  {    
    ...
    destination[0] = xbee868LP._srcMAC[0]; 
    destination[1] = xbee868LP._srcMAC[1]; 
    destination[2] = xbee868LP._srcMAC[2]; 
    destination[3] = xbee868LP._srcMAC[3]; 
    destination[4] = xbee868LP._srcMAC[4]; 
    destination[5] = xbee868LP._srcMAC[5]; 
    destination[6] = xbee868LP._srcMAC[6]; 
    destination[7] = xbee868LP._srcMAC[7]; 
    ...
    // send XBee packet
    error = xbee868LP.send( destination, "Message_from_RX_node" );       
