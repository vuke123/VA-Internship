/*  
 *  ------  GPRS_SIM928A_02 - Changing power mode from ON to RF_OFF  -------- 
 *  
 *  Explanation: This example shows how power off the RF circuits 
 *  from GPRS_SIM928A module
 *  
...
void setup()
{
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        USB.println(F("Power off the RF circuits of GPRS_SIM928A module")); 
        
        if (GPRS_SIM928A.setMode(GPRS_PRO_RF_OFF) == 1)
        {
