/*
 *  ------ NB_IoT 04 - Basic connection to LTE Cat-M1 network --------
 *
...
void loop()
{
  ...
  if (error == 0)
  {
    ...
    ////////////////////////////////////////////////
    error = BG96.lteM1Connection(apn, band, network_operator, operator_type);
    if (error == 0)
    {
      USB.println(F("1.1. LTE Cat-M1 connection: OK "));

      ////////////////////////////////////////////////
      // 1.2.1 LTE Cat-M1 Context Activation
      ////////////////////////////////////////////////
      error = BG96.contextActivation(1,5);
      if (error == 0)
      {
        USB.println(F("1.1. LTE Cat-M1 context connection: OK "));
