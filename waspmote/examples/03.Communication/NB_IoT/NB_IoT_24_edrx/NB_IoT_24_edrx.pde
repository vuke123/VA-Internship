/*
 *  ------ NB_IoT 24 - eIDRX mode --------
 *
 *    setting eIDRX mode. By default is disabled.
 *
...
/////////////////////////////////////
// e-IDRX parameters - By default is disabled.
/////////////////////////////////////
bool eIDRX_state = eIDRX_ENABLED;   // eIDRX_ENABLED or eIDRX_DISBLED
char Requested_eDRX_value[] = "0011";
// SERVER settings
/////////////////////////////////////
...
void setup()
{
  ...
  else
  {
    ...
    ////////////////////////////////////////////////
    // 2. Set eIDRX parameters
    ////////////////////////////////////////////////
    BG96.set_eIDRX(eIDRX_state, Requested_eDRX_value);
    ...
    if (error == 0)
    {
      USB.println(F("3. NB-IoT connection: OK "));
    }
    else
    {
      USB.println(F("3. ERROR ")); USB.println(error,DEC);
      USB.println(BG96._buffer, BG96._length);
    }

      ////////////////////////////////////////////////
      // 3.1 NB-IoT Context Activation
      ////////////////////////////////////////////////
      error = BG96.contextActivation(1,5);
      if (error == 0)
      {
        USB.println(F("3.1. NB-IoT context connection: OK "));
      }
      else
      {
        USB.println(F("3.1. Context connection ERROR ")); USB.println(error,DEC);
        USB.println(BG96._buffer, BG96._length);
      }
      ////////////////////////////////////////////////
      ...
      if (error == 0)
      {
        USB.println(F("4. Setting DNS server: OK "));
      }
      else
      {
        USB.println(F("4. DNS error: ")); USB.println(error,DEC);
        USB.println(BG96._buffer, BG96._length);
      }
...
void loop()
{
    for (int i = 0; i<3;i++)
    {
      ...
      ////////////////////////////////////////////////
      // 5. Sending HTTP GET frame
      ////////////////////////////////////////////////
      error = BG96.http( WaspBG96::HTTP_GET, host, port, resource);
      // Check the answer
      if (error == 0)
      {
        USB.print(F("5. Done. HTTP code: "));
      ...
      {
        USB.print(F("5. Failed. Error code: "));
        USB.println(error, DEC);
      }
      ...
      if (error == 0)
      {
        USB.println(F("6. NB-IoT module sleep mode activated!"));
        USB.print(F("Time: "));
        USB.println(millis()-previous);
      }
      else
      {
        USB.print(F("6.Error activating sleep mode. Error code: "));
        USB.println(error, DEC);
        USB.println(BG96._buffer, BG96._length);
      }

      //////////////////////////////////////////////////
      // 7. Entering Waspmote deep sleep mode
      //////////////////////////////////////////////////
      USB.println(F("7. Enter deep sleep..."));
      PWR.deepSleep("00:00:01:00", RTC_OFFSET, RTC_ALM1_MODE1, ALL_OFF);

      USB.ON();
      USB.println(F("8. Waspmote Wake up!!\n\n"));

      ////////////////////////////////////////////////
      // 9. Sleep NB-IoT module mode OFF - NB-IoT WakeUp
      ////////////////////////////////////////////////
      previous = millis();
      error = BG96.nbiotSleepMode(0);
      if (error == 0)
      {
        USB.println(F("9. NB-IoT module sleep mode desactivated!"));
        USB.print(F("Time: "));
        USB.println(millis()-previous);
      }
      else
      {
        USB.print(F("9.Error disabling sleep mode. Error code: "));
        USB.println(error, DEC);
        USB.println(BG96._buffer, BG96._length);
      }
    }
   ...
   ////////////////////////////////////////////////
   // 10. Power OFF the module
   ////////////////////////////////////////////////
   error = BG96.OFF();
   if (error == 0)
    {
      USB.println(F("10. Module is power off"));
      //USB.println(BG96._buffer, BG96._length);
    }
    else
    {
      USB.println(F("10. Power off ERROR"));
    }
