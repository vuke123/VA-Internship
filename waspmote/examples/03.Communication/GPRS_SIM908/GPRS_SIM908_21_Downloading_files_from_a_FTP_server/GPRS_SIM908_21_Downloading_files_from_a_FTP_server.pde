/*  
 *  ------  GPRS_SIM908_21 - Downloading files from a FTP server  -------- 
 *  
    ...
    if ((answer == 1) || (answer == -3))
    {
        ...
        if (answer == 1)
        {
            ...
            if (answer == 1)
            {
                ...
                answer = GPRS_SIM908.downloadFile( "/ftp1/ftp2/fileFTP1.txt", "/dirSD1/dirSD2/fileSD1.txt", "username", "password", "IP_server", "port", 1);
                ...
                answer = GPRS_SIM908.downloadFile("/fileFTP2.txt", "/fileSD2.txt", "username", "password", "IP_server", "port", 1);
