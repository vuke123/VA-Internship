/*  
 *  ------------  GPRS_SIM908_18 - I/O control by TCP  ------------ 
 *  
        ...
        if (answer == 1)
        {
            ...
            { 
                ...
                { 
                    ...
                    if (GPRS_SIM908.sendData("Waspmote ready!\n") == 1) 
                    { 
                        USB.println(F("Done")); 
                    } 
                    else 
                    ...
                    { 
                        ...
                        if (answer == 3)
                        {
                            ...
                            strncpy(buffer, GPRS_SIM908.buffer_GPRS, strchr(GPRS_SIM908.buffer_GPRS, '/') - GPRS_SIM908.buffer_GPRS);                
                            USB.print(F("Order: ")); 
                            USB.println(buffer); 
                            ...
                            { 
                                strcpy(buffer, strrchr(GPRS_SIM908.buffer_GPRS, '/') + 1); 
                                USB.print(F("Pin: ")); 
                                USB.println(buffer); 
                                switch(buffer[0]) 
                                { 
