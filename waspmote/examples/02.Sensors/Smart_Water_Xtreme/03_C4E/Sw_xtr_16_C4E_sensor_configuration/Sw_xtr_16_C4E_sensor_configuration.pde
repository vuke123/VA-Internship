/*
    ----------- [Sw_xtr_16] - C4E sensor configuration -----------------

    Explanation: Basic example that initializes the sensor with
    default configuration for averaging and selected range for conductivity
...
void setup()
{
  USB.println(F("C4E configuration example"));
  ...
  //!  
  //! Param: range (Range for C4E measure)
