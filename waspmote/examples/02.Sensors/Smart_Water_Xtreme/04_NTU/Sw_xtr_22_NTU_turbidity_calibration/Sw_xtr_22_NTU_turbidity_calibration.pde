/*
    ----------- [Sw_xtr_22] - NTU turbidity calibration --------------------

    Explanation: MENU ASSISTED CALIBRATION PROCESS for NTU turbidity 
    parameter of NTU sensor
...
void setup()
{
  ...
  mySensor.calibrationProcess(NTU_TURBIDITY);
