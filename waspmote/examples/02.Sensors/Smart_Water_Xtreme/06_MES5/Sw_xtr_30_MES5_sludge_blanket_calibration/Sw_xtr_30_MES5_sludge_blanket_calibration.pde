/*
    ----------- [Sw_xtr_30] - MES5 Sludge blanket calibration --------------------

    Explanation: MENU ASSISTED CALIBRATION PROCESS for sludge blanket of
    MES5 sensor
...
void setup()
{
  ...
  mySensor.calibrationProcess(SLUDGE_BLANKET);
