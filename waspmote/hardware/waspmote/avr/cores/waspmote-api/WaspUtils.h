/*! \file WaspUtils.h
    ...
    Version:		3.4
    Design:			David Gascon
    Implementation:	David Cuartielles
...
class WaspUtils
{
  ...
  */
  ...
  //! It inserts a new item in arr at position pos
  /*!
  */
  uint8_t insert(uint8_t *arr, uint16_t size, uint8_t new_item, uint16_t pos);
