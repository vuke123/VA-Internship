 ...
 *  Version:		3.4
 *  Design:			David Gascon
 *  Implementation:	David Cuartielles, Yuri Carmona
 */
...
/*
 * @brief Function to insert a new item in arr at position pos
 *
 * @remarks pos in index 0 would be equal to 1
 */
uint8_t WaspUtils::insert(uint8_t *arr, uint16_t size, uint8_t new_item, uint16_t pos)
{
    int i;
