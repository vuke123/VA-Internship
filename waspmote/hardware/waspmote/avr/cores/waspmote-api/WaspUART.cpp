								...
								uint32_t timeout)
{
	...
	if ((_uart == UART1) && (Utils._mux_state != _mux_state))
	{
		switch (_mux_state)
		{
			case WaspUtils::MUX_UART1_SOCKET1:
				Utils.setMuxSocket1();
				break;
			case WaspUtils::MUX_UART1_GPS:
				Utils.setMuxGPS();
				break;
			case WaspUtils::MUX_UART1_AUX1:
				Utils.setMuxAux1();
				break;
			case WaspUtils::MUX_UART1_AUX2:
				Utils.setMuxAux2();
				break;
		}
		beginUART();
